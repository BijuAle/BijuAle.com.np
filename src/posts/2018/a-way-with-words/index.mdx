...
Vocabulary researchers have proposed a better metaphor for the right way of learning words - the dimmer-switch phenomenon. A smart switch which can intensify the light, with the knob’s turn. We first learn the dictionary definition, & gradually become comfortable with its usage in various contexts; next, we draw figurative parallels, dissect its morphine, & go on to store the word in our mental schema.
...
Finally, for further reading these are excellent resources to peruse

- (Vocabulary Builder) Lewis, N., 2008. Word Power Made Easy. Delhi: GOYAL SaaB.
- (General Writing Guide) Strunk, W. and White, E., 2000. The Elements Of Style. Boston: Allyn and Bacon.
- (Academic Writing Guide) Sword, H., 2012. Stylish Academic Writing. Cambridge, Mass.: Harvard University Press.
