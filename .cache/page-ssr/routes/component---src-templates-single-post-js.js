...
// EXTERNAL MODULE: external "/home/biju/GitHub/a/blog/node_modules/react/index.js"
...
`;const Pagination=({currentPage,numPages,isFirst,isLast,prevPage,nextPage})=>{return/*#__PURE__*/index_js_default().createElement(PaginationStyle,{isFirst:isFirst,isLast:isLast},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{title:`Go back to Page: `+prevPage,to:prevPage},"\u2190 \xA0"),/*#__PURE__*/index_js_default().createElement("span",null,currentPage," of ",numPages),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{title:`Go to page: `+nextPage,to:nextPage},"\xA0 \u2192"));};
;// CONCATENATED MODULE: ./src/components/PostListItem.js
const PostListItem=({date,author,title,excerpt,slug,tags})=>{return/*#__PURE__*/index_js_default().createElement("div",null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:slug},title),/*#__PURE__*/index_js_default().createElement("span",{style:{float:"right",opacity:"50%"}},date));};
;// CONCATENATED MODULE: ./src/components/Layout.js
const LayoutStyle=styled_components_esm.div`
  min-height: 100vh;
  display: grid;
...
`;const Layout=({children})=>{return/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement(LayoutStyle,null,/*#__PURE__*/index_js_default().createElement(Header,null),/*#__PURE__*/index_js_default().createElement("main",null,children),/*#__PURE__*/index_js_default().createElement(Footer,null)));};
;// CONCATENATED MODULE: ./src/components/Header.js
const Header=()=>{const HeaderStyle=styled_components_esm.div`
  ...
  `;const MottoStyle=styled_components_esm.div`
    opacity: 65%;
    font-style: italic;
    float: right;
  ...
  `;return/*#__PURE__*/index_js_default().createElement(HeaderStyle,null,/*#__PURE__*/index_js_default().createElement("header",null,/*#__PURE__*/index_js_default().createElement("nav",null,/*#__PURE__*/index_js_default().createElement("div",{style:{opacity:"50%",fontSize:"1.5rem",display:"inline-block"}},"BIJU ALE"),/*#__PURE__*/index_js_default().createElement("ul",null,/*#__PURE__*/index_js_default().createElement("li",null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},"HOME")),/*#__PURE__*/index_js_default().createElement("li",null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/about"},"ABOUT")),/*#__PURE__*/index_js_default().createElement("li",null,/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/contact"},"CONTACT")))),/*#__PURE__*/index_js_default().createElement(MottoStyle,null,/*#__PURE__*/index_js_default().createElement("p",null,"And you shall know the truth, ",/*#__PURE__*/index_js_default().createElement("br",null),"& the truth shall make you free.",/*#__PURE__*/index_js_default().createElement("br",null),"\u2014John 8:32"))));};
;// CONCATENATED MODULE: ./src/components/Footer.js
const Footer=()=>{const FooterStyle=styled_components_esm.div`
    margin: 0.5rem 0 0.5rem 0;
    opacity: 60%;
    font-size: 0.8rem;
  `;return/*#__PURE__*/index_js_default().createElement(FooterStyle,null,/*#__PURE__*/index_js_default().createElement("footer",null,/*#__PURE__*/index_js_default().createElement("hr",null),"Biju Ale \xA9 2017 ",new Date().getFullYear(),"\xA0 All Rights Reserved"));};
// EXTERNAL MODULE: ./node_modules/lodash/kebabCase.js
var kebabCase = __webpack_require__(1804);
var kebabCase_default = /*#__PURE__*/__webpack_require__.n(kebabCase);
;// CONCATENATED MODULE: ./src/components/TagList.js
const TagListStyle=styled_components_esm.div``;const TagList=({data})=>{return/*#__PURE__*/index_js_default().createElement("ul",{style:{marginTop:"3rem"}},"Tags: ",data.allMdx.group.map(tag=>/*#__PURE__*/index_js_default().createElement("li",{key:tag.fieldValue,style:{listStyle:"none",display:"inline",padding:"2px",marginRight:".5rem"}},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:`/tags/${kebabCase_default()(tag.fieldValue)}/`},tag.fieldValue," (",tag.totalCount,")"))));};
...
const query="2935582604";const SEO=({title,description,image,article})=>{const{pathname}=(0,es.useLocation)();const{site}=(0,gatsby_browser_entry.useStaticQuery)(query);const{defaultTitle,defaultDescription,siteUrl,defaultImage,twitterUsername,keywords}=site.siteMetadata;const seo={title:title||defaultTitle,description:description||defaultDescription,image:`${siteUrl}${image||defaultImage}`,url:`${siteUrl}${pathname}`,keywords:keywords};return/*#__PURE__*/index_js_default().createElement(Helmet.Helmet,{title:seo.title},/*#__PURE__*/index_js_default().createElement("meta",{name:"keywords",content:seo.keywords}),/*#__PURE__*/index_js_default().createElement("meta",{name:"description",content:seo.description}),/*#__PURE__*/index_js_default().createElement("meta",{name:"image",content:seo.image}),seo.url&&/*#__PURE__*/index_js_default().createElement("meta",{property:"og:url",content:seo.url}),(article?true:null)&&/*#__PURE__*/index_js_default().createElement("meta",{property:"og:type",content:"article"}),seo.title&&/*#__PURE__*/index_js_default().createElement("meta",{property:"og:title",content:seo.title}),seo.description&&/*#__PURE__*/index_js_default().createElement("meta",{property:"og:description",content:seo.description}),seo.image&&/*#__PURE__*/index_js_default().createElement("meta",{property:"og:image",content:seo.image}),/*#__PURE__*/index_js_default().createElement("meta",{name:"twitter:card",content:"summary_large_image"}),twitterUsername&&/*#__PURE__*/index_js_default().createElement("meta",{name:"twitter:creator",content:twitterUsername}),seo.title&&/*#__PURE__*/index_js_default().createElement("meta",{name:"twitter:title",content:seo.title}),seo.description&&/*#__PURE__*/index_js_default().createElement("meta",{name:"twitter:description",content:seo.description}),seo.image&&/*#__PURE__*/index_js_default().createElement("meta",{name:"twitter:image",content:seo.image}));};
...
/* harmony import */ var gatsby_plugin_mdx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9394);
...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1187);
/* harmony import */ var lodash_kebabCase__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1804);
...
/* harmony import */ var _mdx_js_react__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3905);
const query="3110202816";const singlePost=({data,pageContext})=>{const{previous,next}=pageContext;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_3__/* .Layout */ .Ar,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_3__/* .SEO */ .HJ,{title:data.mdx.frontmatter.title}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{style:{fontSize:"1.3rem"}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("b",null,data.mdx.frontmatter.title)),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{style:{marginBottom:"1rem",opacity:"70%",fontSize:".95rem"}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",null,data.mdx.frontmatter.author,"\xA0|\xA0",data.mdx.frontmatter.date,"\xA0|\xA0",data.mdx.frontmatter.tags.map(tag=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",{key:tag},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:`/tags/${lodash_kebabCase__WEBPACK_IMPORTED_MODULE_4___default()(tag)}/`},tag,"\xA0"))))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mdx_js_react__WEBPACK_IMPORTED_MODULE_5__.MDXProvider,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_plugin_mdx__WEBPACK_IMPORTED_MODULE_2__.MDXRenderer,{headings:data.mdx.headings},data.mdx.body)),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("nav",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul",{style:{display:`flex`,flexWrap:`wrap`,justifyContent:`space-between`,listStyle:`none`,padding:0,marginTop:`.5rem`}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{style:{opacity:`90%`,fontStyle:`italic`,float:`right`}},"Other Posts:"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",null,previous&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:previous.fields.slug,rel:"prev"},"\u2190 ",previous.frontmatter.title)),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",null,next&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:next.fields.slug,rel:"next"},next.frontmatter.title," \u2192")))));};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (singlePost);
