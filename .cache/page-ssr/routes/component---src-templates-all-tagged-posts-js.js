...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1187);
const pageQuery="3979539623";const AllTaggedPosts=({pageContext,data,location})=>{const{tag}=pageContext;const{edges,totalCount}=data.allMdx;const tagHeader=`${totalCount} essay${totalCount===1?"":"s"} under "${tag}"`;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_2__/* .Layout */ .Ar,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_2__/* .SEO */ .HJ,{title:"Tagged Essays"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:"/"},"\u2190"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",null,tagHeader),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul",{style:{marginTop:"1rem"}},edges.map(({node})=>{const{slug}=node.fields;const{title}=node.frontmatter;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",{key:slug},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:slug},title),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",{style:{float:"right",opacity:"50%"}},node.frontmatter.date));})));};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AllTaggedPosts);
...
;
//# sourceMappingURL=component---src-templates-all-tagged-posts-js.js.map