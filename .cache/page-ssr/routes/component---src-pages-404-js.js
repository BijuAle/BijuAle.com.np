...
var components = __webpack_require__(1187);
...
const notFound=({data})=>{const image=R(data.file);return/*#__PURE__*/index_js_default().createElement(components/* Layout */.Ar,null,/*#__PURE__*/index_js_default().createElement("p",null,"Sorry. Could not find that resource in the entire Middle Earth."),/*#__PURE__*/index_js_default().createElement("p",{margin:"1em 0 1em 0",lineHeight:"1.1em",fontSize:"1.06em"},"As Tolkien said, not all those who wander are lost. But you seem to have lost your way. The page you are looking for may have been moved or deleted or may not exist at all. This case is also called a \"404 Not Found\"."),/*#__PURE__*/index_js_default().createElement(Y,{image:image,draggable:false,alt:"Map of Middle Earth.",title:"Map of Middle Earth."}));};/* harmony default export */ const _404 = (notFound);const notFoundQuery="1047875402";
