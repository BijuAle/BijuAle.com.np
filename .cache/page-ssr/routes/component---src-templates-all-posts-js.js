...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1187);
const pageQuery="436227609";const allPosts=({pageContext,data})=>{const{currentPage,numPages}=pageContext;const isFirst=currentPage===1;const isLast=currentPage===numPages;const prevPage=currentPage-1===1?"/":`/${currentPage-1}`;const nextPage=`/${currentPage+1}`;const posts=data.allMdx.edges;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Layout */ .Ar,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .SEO */ .HJ,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{style:{marginBottom:".5rem",fontWeight:"bold"}},"ESSAYS"),posts.map(post=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .PostListItem */ .BM,{key:post.node.fields.slug,date:post.node.frontmatter.date,title:post.node.frontmatter.title,excerpt:post.node.excerpt,slug:post.node.fields.slug,tags:post.node.frontmatter.tags})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Pagination */ .tl,{isFirst:isFirst,isLast:isLast,prevPage:prevPage,nextPage:nextPage,currentPage:currentPage,numPages:numPages}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .TagList */ .PS,{data:data}));};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (allPosts);
...
;
//# sourceMappingURL=component---src-templates-all-posts-js.js.map